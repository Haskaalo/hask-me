...
var request = require('request');
 var replace = result.battletag.replace('#', '-') // pls replace result.battletag with input from index.html(currently dont know how)
...
var data = JSON.parse(body);
        ...
        // put some redirect to an not found player page
    }
});